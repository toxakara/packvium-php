...
final class PackedContainer
{
     ...
     */
    public function __construct(Container $container, int $sequence, array $placements, ?LatticeSummary $latticeSummary = null, array $latticeItems = [])
    {
        $this->container = $container;
        $this->sequence = $sequence;
        $this->placements = $placements;
        $this->latticeSummary = $latticeSummary;
        $this->latticeItems = $latticeItems;
    }
